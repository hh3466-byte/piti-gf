...
const CLINICAL_SIBO_RULES: ClinicalRule[] = [
  // --- קצפת צמחית / קצפת פרווה (ריץ' / השף הלבן צמחית / אלפרו) - GREEN לפיתי ---
  {
    keywords: [
      'קצפת צמחית',
      'קצפת פרווה',
    ...
    verdictHe: 'אור ירוק! קצפת צמחית מותרת לפיתי (0% לקטוז, ללא חלב וללא גלוטן). 🟢',
    explanationHe: 'קצפת צמחית להקצפה (כגון ריץ׳ או קצפת צמחית השף הלבן) הינה מוצר פרווה ללא חלב וללא לקטוז כלל. היא מבוססת על שומן צמחי, מים, סוכר ומייצבים שאינם מתסיסים את חיידקי ה-SIBO במעי הדק (ללא פרוקטנים, ללא לקטוז וללא פוליאולים). מותרת ובטוחה לפיתי כקינוח או לציפוי עוגות ללא גלוטן! מומלץ לצרוך במתינות סבירה (עד 50-60 גרם / 2-3 כפות) בגלל אחוז השומן.',
  ...
  // --- אבקת קקאו 100% טהור (עלית / השחר העולה / מיימונס) - GREEN לפיתי ---
  {
    keywords: [
      'אבקת קקאו',
      'קקאו',
    ...
    verdictHe: 'אור ירוק! אבקת קקאו טהור מותרת ובטוחה לפיתי. 🟢🍫',
  ...
  // --- מיץ תפוזים סחוט טרי (פרי מור / פרי ניב / פריגת) - YELLOW לפיתי ---
  {
    keywords: [
      'מיץ תפוזים',
      'מיץ תפוזים סחוט',
  ...
  // --- חלב דל לקטוז / ללא לקטוז (Lactose-Free & Low Lactose Milk) ---
  {
    ...
    verdictHe: 'אור ירוק! מותר ובטוח לפיתי (הלקטוז פורק מראש לאנזימים פשוטים).',
    explanationHe: 'בחלב דל לקטוז / ללא לקטוז, אנזים הלקטאז מפרק מראש את הלקטוז לגלוקוז וגלקטוז, שנספגים ישירות במעי הדק ללא תסיסה חיידקית. בטוח לחלוטין לפיתי לשתייה עם קפה, להכנת שייקים מותרים או לדייסות דלות FODMAP.',
  ...
  // --- קפה שחור טורקי טהור (עלית / שטראוס / לנדוור) - 100% GREEN לפיתי ---
  {
    keywords: [
      'קפה שחור',
      'קפה טורקי',
    ...
    verdictHe: 'אור ירוק! קפה שחור טהור מותר ובטוח לחלוטין לפיתי. 🟢☕',
  ...
  // --- בירה ומשקאות מאלט (Beer & Malt Beverages) - 100% RED לפיתי ---
  {
    keywords: [
      'בירה',
      'בירה שחורה',
    ...
    verdictHe: 'אור אדום בוהק! בירה ומשקאות מאלט אסורים לחלוטין לפיתי ב-SIBO. 🛑🍺',
  ...
  // --- לחמים ודגנים (Breads & Grains) ---
  {
    ...
    verdictHe: 'אור אדום! אסור לחלוטין לפיתי בשלבי ה-SIBO הפעילים.',
  ...
  // --- שום ובצל (Garlic & Onion) ---
  {
    ...
    verdictHe: 'אור אדום בוהק! אסור בתכלית האיסור לפיתי.',
  ...
  // --- חלבונים טהורים (Clean Proteins) ---
  {
    ...
    verdictHe: 'אור ירוק! מושלם ובטוח לחלוטין לפיתי.',
  ...
  // --- ירקות מותרים דלי FODMAP (Safe Vegetables) ---
  {
    ...
    verdictHe: 'אור ירוק! ירק דל תסיסה, קל לעיכול ומומלץ מאוד לפיתי.',
  ...
  // --- פירות עתירי סוכר מתסיס (Forbidden Fruits) ---
  {
    ...
    verdictHe: 'אור אדום! אסור לפיתי – מכיל עודף פרוקטוז וסורביטול.',
...
export function detectConversationalAdvisoryQuery(query: string, phase: SiboPhase): FoodAnalysisResult | null {
  ...
  if (isDairyGuideQuery) {
    return {
      ...
      detailedExplanation: 'מדריך מוצרי חלב וגבינות בטוחות לפיתי:\n\n' +
  ...
  if (isDessertQuery) {
    return {
      ...
      detailedExplanation: 'קינוחים ומתוקים מותרים לפיתי:\n\n' +
  ...
  if (isVegGuideQuery) {
    return {
      ...
      shortVerdict: 'אור ירוק! מגוון עשיר של ירקות דלי FODMAP מותרים ובטוחים לפיתי!',
  ...
  if (isMealIdeasQuery) {
    return {
      ...
      shortVerdict: 'אור ירוק! שפע ארוחות טעימות, משביעות וקלות לעיכול לפיתי!',
  ...
  if (isDrinkGuideQuery) {
    return {
      ...
      shortVerdict: 'אור ירוק! משקאות מרגיעים ומאיצי תנועתיות מותרים ובטוחים לפיתי!',
  ...
  if (dbMatch) {
    ...
    return {
      ...
      shortVerdict: isGreen
        ? `אור ירוק! ${dbMatch.nameHe} מותר ובטוח לפיתי.`
        : isYellow
        ? `אור צהוב! ${dbMatch.nameHe} מותר אך ורק בכמות מדודה.`
        : `אור אדום! ${dbMatch.nameHe} אסור לחלוטין לפיתי בסיבו.`,
