...
export const SIBOAssistantModal: React.FC<SIBOAssistantModalProps> = ({ currentPhase }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      text: `שלום פיתי ואבא! 🌿 אני יועץ התזונה הקליני המומחה ל-צליאק וללא גלוטן. 
  ...
  const handleToggleVoiceInput = () => {
    ...
    try {
      ...
      recognition.onerror = (event: any) => {
        console.warn('Speech recognition error in צליאק וללא גלוטן assistant:', event.error);
        setIsListening(false);
    ...
    <div id="sibo-consult-container" className="w-full max-w-4xl mx-auto space-y-6 animate-fadeIn">
      ...
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl sm:text-3xl font-black text-stone-900 tracking-tight">
          ייעוץ תזונתי קליני ל-צליאק וללא גלוטן 💬
        </h2>
